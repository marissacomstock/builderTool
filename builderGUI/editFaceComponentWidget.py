...
ASSIGNPATH = os.path.join(FILEPATH, "editFaceComponentWidget.ui")
...
class AssignNewComponentWidget(editWidget.EditWidget):
    ...
    def __init__(self, parent=None,
        ...
        self.compWidget.nodeListAdd_pushButton.clicked.connect(self.assignObject)
        self.compWidget.nodeListRemove_pushButton.clicked.connect(self.assignObject)
        self.compWidget.nodeListAdd_pushButton.clicked.connect(self.assignObject)
        self.compWidget.nodeListRemove_pushButton.clicked.connect(self.assignObject)
    ...
    def initWindow(self, buildDict=None, hierDict=None, attachDict=None):
        ...
        if buildDict:
            ...
            if 'nodeList' in buildDict and buildDict['nodeList']:
                for i, item in enumerate(buildDict['nodeList']):
                    self.compWidget.nodeList_listWidget.insertItem(i, item)
    ...
    def slotReset(self):
        ...
        self.compWidget.nodeList_listWidget.clear()
    ...
    def update(self):
        ...
        #get endlist
        nodeList = list()
        for index in xrange(self.compWidget.nodeList_listWidget.count()):
            nodeList.append(self.compWidget.nodeList_listWidget.item(index).text())
    ...
    def setBuildString(self, oldLimb):
        ...
        if self.puppet and self.limb:
            ...
            buildObj.setBuildValues(compType=self.compType,
                                    ...
                                    nodeList=self._componentAttrList[3],
